...
_ZH_CN = {
    ...
    'Experimental loss rate exceeded the 5% recapture threshold.': '实验性丢失率超过 5% 建议重录阈值。',
    ...
    'Finalizing capture: saving remaining data and building the quality report.': '正在结束录制：保存剩余数据并生成质量报告。',
}
